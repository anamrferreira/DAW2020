    ...
    <xsl:template match="/">
        <xsl:result-document href="site/index.html">
            <html>
                ...
                <body style="margin:0px;padding:0px;font-family:Arial;font-size:12pt;background-color:#EEEEEE">
                    ...
                    <main style="margin-left:100px">
                        <ol>
                            <xsl:apply-templates select="//ARQELEM" mode="indice">
                                <!-- exclui espaços iniciais e ordena por ordem alfabética consoante o alfabeto português -->
        ...
        <html>
            <head>
                <style>
                    ...
                    div:hover{color:#FFFFFF;background-color:#FF8A00}
                </style>
            </head>
            ...
            <body>
                <li>
                    ...
                    <a href="{generate-id()}.html" style="color:#000000;text-decoration:none">
                        <div style="padding:1px;padding-left:20px;margin-bottom:5px;margin-right:130px">
                            <p><b><xsl:value-of select="IDENTI"/></b></p>
                            <p><small><xsl:value-of select="normalize-space(FREGUE)"/>, <xsl:value-of select="normalize-space(CONCEL)"/></small></p>
                        </div>
                    </a>
                </li>
            </body>
            ...
            <html>
                <head>
                    ...
                    <head>
                        <style>
                            ...
                            div:hover{color:#FF8A00;background-color:#FFFFFF;border:solid 2px #FF8A00}
                        </style>
                    </head>
                </head>
                ...
                <body style="margin:0px;padding:0px;font-family:Arial;font-size:12pt;background-color:#EEEEEE">
                    <header style="padding:10px;background-color:#100E17;text-align:center">
                        ...
                        <h2 style="color:#FF8A00"><xsl:value-of select="IDENTI"/></h2>
                    </header>
                    
                    <main style="text-align:justify;padding:10px;padding-left:30px;padding-right:30px;margin-top:20px;margin-bottom:20px;margin-left:130px;margin-right:130px;background-color:#FFFFFF">
                    ...
                    <center>
                        <a href="index.html#i{generate-id()}" style="color:#FFFFFF;text-decoration:none">
                    ...
                    <footer style="padding:10px;margin-top:20px;background-color:#100E17;text-align:center">
                        <span style="color:#FFFFFF">
                            <xsl:value-of
                                select="format-dateTime(current-dateTime(),'Página gerada em: [D01]/[M01]/[Y0001] [H01]:[m01]')"/>
                        </span>
